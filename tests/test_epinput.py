...
class Test_EPInput(unittest.TestCase):
    ...
    def _test___init__epjson(self):
        ""
        epi=EPInput(fp='files/1ZoneUncontrolled.epJSON')
        ...
        # print(dict(j[0]))
        # print(j[0].keys())
        # print(j[0].north_axis)
        # j[0].north_axis=180
        # print(j[0].north_axis)
        
        # print(j['Building'])
        
        # print(j.get_object('Simple One Zone (Wireframe DXF)'))
    ...
    def test___init__idf(self):
        ""
        epi=EPInput(fp='files/1ZoneUncontrolled.idf',
                    schema=EPSchema('files/Energy+.schema.epJSON'))
        self.assertIsInstance(epi,
                              EPInput)
